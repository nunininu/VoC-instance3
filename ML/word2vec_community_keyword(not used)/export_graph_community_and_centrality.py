...
annotated_edges.to_csv("keyword_edge_annotated.csv", index=False)
...
node_df.to_csv("keyword_nodes_annotated.csv", index=False)

print("✅ Done: keyword_edge_annotated.csv / keyword_nodes_annotated.csv")
