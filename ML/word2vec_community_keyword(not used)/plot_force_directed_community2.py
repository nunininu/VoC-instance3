...
# 데이터 로딩
df_edges = pd.read_csv("keyword_edge_annotated2.csv")
df_nodes = pd.read_csv("keyword_nodes_annotated2.csv")
...
# 시각화 출력
net.show("force_directed_community_min3.html")
print("📤 시각화 완료: force_directed_community_min3.html")
